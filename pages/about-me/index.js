...
import { toTreeV1 } from 'lib/tree';

const flatten = [
  { id: 1, name: 'Tech skills' },
  { id: 2, name: 'Frontend', parent: 1 },
  { id: 7, name: 'UI Libraries', parent: 2 },
  { id: 7, name: 'Data Fetching', parent: 2 },
  { id: 7, name: 'Data Management', parent: 2 },
  { id: 8, name: 'Component Libraries', parent: 2 },
  { id: 9, name: 'Tools', parent: 2 },
  { id: 10, name: 'Styling', parent: 2 },
  { id: 3, name: 'Backend', parent: 1 },
  { id: 6, name: 'Languages', parent: 1 },
  { id: 4, name: 'DevOps', parent: 1 },
  { id: 5, name: 'Game Development', parent: 1 }
];

const skillsTree = toTreeV1(flatten);
